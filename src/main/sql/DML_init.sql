...
VALUES (1, 'admin', localtimestamp, null, null, false, null, null, 'США',
        ...
        2, '1.jpg', 1999, 'Бойцовский клуб', 8.66);
...
VALUES (2, 'admin', localtimestamp, null, null, false, null, null, 'США',
        ...
        3, '2.jpg', 1994, 'Криминальное чтиво', 8.646);
...
VALUES (3, 'admin', localtimestamp, null, null, false, null, null, 'США',
        ...
        2, '3.jpg', 1994, 'Форрест Гамп', 8.919);
...
VALUES (4, 'admin', localtimestamp, null, null, false, null, null, 'США',
        ...
        2, '4.jpg', 1994, 'Побег из Шоушенка', 9.108);
...
VALUES (5, 'admin', localtimestamp, null, null, false, null, null, 'США',
        ...
        2, '5.jpg', 1993, 'Список Шиндлера', 8.843);
...
VALUES (6, 'admin', localtimestamp, null, null, false, null, null, 'СССР',
        ...
        4, '6.jpg', 1975, 'Они сражались за Родину', 8.448);
...
VALUES (9, 'admin', localtimestamp, null, null, false, null, null, 'США',
        ...
        0, '9.jpg', 2014, 'Интерстеллар', 8.622);
...
VALUES (11, 'admin', localtimestamp, null, null, false, null, null, 'США',
        ...
        0, '11.jpg', 1985, 'Назад в будущее', 8.644);
...
--         0, '12.jpg', 1984, 'Терминатор', 7.979);
...
INSERT INTO public.roles (id, description, title) VALUES (1, 'Пользователь', 'USER');
...
VALUES (1, 'admin', localtimestamp, null, null, false, null, null, 200, '2033-08-15', '20:30:00', 11);

INSERT INTO public.film_sessions (id, created_by, created_when, deleted_by, deleted_when, is_deleted,
                                  updated_by, updated_when, price, start_date, start_time, film_id)
VALUES (2, 'admin', localtimestamp, null, null, false, null, null, 200, '2033-08-15', '10:30:00', 9);
...
VALUES (1, 'u', localtimestamp, null, null, false, null, null, 200, true, 1, 1);


INSERT INTO public.orders_seats (order_id, seat_id) VALUES (1, 3);
...
VALUES (1, 'u', '2023-01-01 11:11:11.000000', null, null, false, null, null, 'Ok.', 11, 1);
